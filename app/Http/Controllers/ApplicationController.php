...
class ApplicationController extends Controller
{
    ...
    public function show(Workspace $workspace, Application $application): Response
    {
        ...
        $application->load([
            'targets' => fn ($q) => $q->with(['framework', 'pipelineSteps', 'webhookConfigs.branchMappings', 'targetEnvironments.environment', 'targetEnvironments.variables', 'targetEnvironments.server']),
            'environments',
        ]);
